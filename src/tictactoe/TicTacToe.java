...
public class TicTacToe {
     ...
     * @param taulerJoc representa les cel·les del tauler de joc, de mida NxN
     */
    ...
    /**
     * Retorna diferents caràcters segon el paràmetre
     * @param i contingut element del tauler joc
     * @return Simbol '_' si i=-3; simbol '0' si
     */
    ...
    /**
     * Fa el moviment mitjançant un random dins de les cel·les
     * @param taulerJoc representa les cel·les del tauler de joc, de mida NxN
     */
    ...
    /**
     * Fa el moviment el jugador indicant la posició per consola
     * @param taulerJoc representa les cel·les del tauler de joc, de mida NxN
     */
